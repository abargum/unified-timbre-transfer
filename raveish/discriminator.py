...
class LatentDiscriminator(nn.Module):
    def __init__(self, latent_size=64, num_classes=13, num_layers=2):
        ...
        net.append(nn.Conv1d(latent_size // 2,
                             latent_size // 4,
                             7,
                             stride=1,
                             padding=cc.get_padding(7, mode="centered")[-1],
        ...
        net.append(nn.BatchNorm1d(latent_size // 4))
        net.append(nn.LeakyReLU(.2))
        net.append(nn.Conv1d(latent_size // 4,
                             num_classes,
                             7,
                             stride=1,
                             padding=cc.get_padding(7, mode="centered")[-1],
