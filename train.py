...
flags.DEFINE_string('db_path_train',
                    None,
                    help='Preprocessed training dataset path',
                    required=True)
flags.DEFINE_string('db_path_test',
                    None,
...
flags.DEFINE_integer('val_every', 25000, help='Checkpoint model every n steps')
